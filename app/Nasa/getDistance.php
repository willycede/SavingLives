...
function distance($lat1, $lon1, $lat2, $lon2) {
    ...
    $dist = floatval(sin(deg2rad(floatval($lat1))) )* floatval(sin(deg2rad(floatval($lat2)))) +  floatval(cos(deg2rad(floatval($lat1)))) * floatval(cos(deg2rad(floatval($lat2)))) * floatval(cos(deg2rad(floatval($theta))));
